export const cardLibrary = [
    ...
    { id: "c1", name: "Eager Recruit", cost: 1, attack: 2, health: 1, type: "Creature", rarity: "common", mechanics: [] },
    { id: "c2", name: "Forest Guardian", cost: 2, attack: 1, health: 3, type: "Creature", rarity: "common", mechanics: ["Taunt"] },
    { id: "c3", name: "Flame Imp", cost: 1, attack: 3, health: 2, type: "Creature", rarity: "common", mechanics: ["Deploy"], deployActionId: 'dealDamageToSelf', deployParams: { amount: 1 }, effectText: "Deploy: Deal 1 damage to yourself." },
    { id: "c4", name: "Nimble Scout", cost: 2, attack: 2, health: 2, type: "Creature", rarity: "common", mechanics: ["Swift"] },
    { id: "c5", name: "Stone Defender", cost: 3, attack: 2, health: 4, type: "Creature", rarity: "common", mechanics: [] },
    { id: "c6", name: "Healing Acolyte", cost: 2, attack: 1, health: 2, type: "Creature", rarity: "common", mechanics: ["Deploy"], deployActionId: 'restoreHealthToSelf', deployParams: { amount: 2 }, effectText: "Deploy: Restore 2 health to your hero." },
    { id: "c7", name: "Raging Berserker", cost: 3, attack: 3, health: 3, type: "Creature", rarity: "common", mechanics: ["Frenzy"], frenzyActionId: 'gainAttack', frenzyActionParams: { amount: 2 }, effectText: "Frenzy: Gains +2 Attack the first time it survives damage." },
    { id: "c15", name: "Shadow Panther", cost: 3, attack: 4, health: 2, type: "Creature", rarity: "common", mechanics: ["Stealth"], effectText: "Stealth" },

    // --- New Common Creatures ---
    { id: "c9", name: "Shield Bearer", cost: 1, attack: 0, health: 2, type: "Creature", rarity: "common", mechanics: ["Taunt"] },
    { id: "c10", name: "River Crocolisk", cost: 2, attack: 2, health: 3, type: "Creature", rarity: "common", mechanics: [] },
    { id: "c11", name: "Spider Tank", cost: 3, attack: 3, health: 4, type: "Creature", rarity: "common", mechanics: [] },
    { id: "c12", name: "Stormwind Knight", cost: 4, attack: 2, health: 5, type: "Creature", rarity: "common", mechanics: ["Swift"] },
    { id: "c13", name: "Murloc Raider", cost: 1, attack: 2, health: 1, type: "Creature", rarity: "common", mechanics: [] },
    { id: "c14", name: "Enraged Gryphon", cost: 4, attack: 3, health: 4, type: "Creature", rarity: "common", mechanics: ["Frenzy"], frenzyActionId: 'gainAttack', frenzyActionParams: { amount: 3 }, effectText: "Frenzy: Gains +3 Attack the first time it survives damage." },
    ...
    { id: "r2", name: "War Golem", cost: 6, attack: 6, health: 6, type: "Creature", rarity: "rare", mechanics: [] },
    { id: "r3", name: "BF Commander", cost: 5, attack: 4, health: 4, type: "Creature", rarity: "rare", mechanics: ["Aura"], effectText: "Aura: Your other creatures have +1 Attack." },
    ...
    // --- New Rare Creatures ---
    { id: "r5", name: "Knight Protector", cost: 3, attack: 3, health: 3, type: "Creature", rarity: "rare", mechanics: ["Taunt"] },
    { id: "r6", name: "Cult Adept", cost: 4, attack: 3, health: 2, type: "Creature", rarity: "rare", mechanics: ["Deploy"], deployActionId: 'drawCards', deployParams: { amount: 1 }, effectText: "Deploy: Draw a card." },
    { id: "r7", name: "Booty Bay Bodyguard", cost: 5, attack: 5, health: 4, type: "Creature", rarity: "rare", mechanics: ["Taunt"] },
    { id: "r8", name: "Priestess of Elune", cost: 5, attack: 4, health: 4, type: "Creature", rarity: "rare", mechanics: ["Deploy"], deployActionId: 'restoreHealthToSelf', deployParams: { amount: 4 }, effectText: "Deploy: Restore 4 health to your hero." },
    { id: "r9", name: "Jungle Stalker", cost: 5, attack: 4, health: 4, type: "Creature", rarity: "rare", mechanics: ["Stealth"], effectText: "Stealth" },

    // --- New Epic Creatures ---
    { id: "e1", name: "Lord of the Arena", cost: 6, attack: 6, health: 5, type: "Creature", rarity: "epic", mechanics: ["Taunt"] },
    { id: "e2", name: "War Golem Veteran", cost: 7, attack: 7, health: 7, type: "Creature", rarity: "epic", mechanics: [] },
    ...
    { id: "whelp", name: "Dragon Whelp", cost: 0, attack: 3, health: 3, type: "Creature", rarity: "token", mechanics: [], collectible: false },

    // --- New Legendary Card ---
    { id: "l2", name: "Obsidian Destroyer", cost: 9, attack: 7, health: 7, type: "Creature", rarity: "legendary", mechanics: ["Taunt", "Deploy"], deployActionId: 'summonCreature', deployParams: { cardId: "scarab", count: 1 }, effectText: "Taunt. Deploy: Summon a 1/1 Scarab with Taunt." },
